<#macro login path isRegisterForm>
    <form action="${path}" method="post">
        ...
        <#if isRegisterForm>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="email" name="email" value="<#if user??>${user.email}</#if>"
                           class="form-control ${(emailError??)?string('is-invalid', '')}" placeholder="Введите Ваш Email"/>
                    <#if emailError??>
                        <div class="invalid-feedback">
                            ${emailError}
                        </div>
            ...
            <div class="col-sm-6">
                <div class="g-recaptcha" data-sitekey="6Lel1V0fAAAAAB4LCvOE_ez0uIfCRQS7q1UQEfIF"></div>
                <#if captchaError??>
